...
public class UpcomingMovies implements Parcelable {
  ...
  public UpcomingMovies(int id, String title, String overview, String posterPath,
      String backdropPath, int voteCount, float voteAverage, String releaseDate) {
    this.id = id;
    this.title = title;
  ...
  public static Creator<UpcomingMovies> getCREATOR() {
    return CREATOR;
  }
  ...
  public static final Creator<UpcomingMovies> CREATOR = new Creator<UpcomingMovies>() {
    @Override public UpcomingMovies createFromParcel(Parcel in) {
      return new UpcomingMovies(in);
    }

    @Override public UpcomingMovies[] newArray(int size) {
